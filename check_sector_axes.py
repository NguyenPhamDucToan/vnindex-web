...
signed off on. Labels were later written out in full ("Biên LN ròng" ->
"Biên lợi nhuận ròng"); the metrics themselves are unchanged. Radar spokes are the non-`extra` axes, in order.
...
APPROVED = {
    "Ngân hàng": ["NIM", "CIR", "Chi phí tín dụng", "LDR", "ROE", "Vốn chủ sở hữu / Tổng tài sản"],
    "Chứng khoán": ["Tài sản tài chính / Tổng tài sản", "Dư nợ margin / Vốn chủ sở hữu", "Đòn bẩy",
                    "Biên lợi nhuận ròng", "ROE", "Upside"],
    "Bảo hiểm": ["Đầu tư / Tổng tài sản", "Biên lợi nhuận ròng", "ROE", "Đòn bẩy",
                 "Chất lượng lợi nhuận", "Upside"],
    "Bất động sản": ["Biên gộp", "Hàng tồn kho / Tổng tài sản", "D/E", "Dòng tiền kinh doanh / Lợi nhuận sau thuế", "ROE", "Upside"],
    "Xây dựng": ["Biên gộp", "Số ngày phải thu", "D/E", "Dòng tiền kinh doanh / Lợi nhuận sau thuế", "ROE", "Upside"],
    "Bán lẻ": ["Biên gộp", "Vòng quay tồn kho", "Vòng quay tài sản", "Biên lợi nhuận ròng", "CCC", "ROE"],
    "Bán buôn": ["Biên gộp", "Vòng quay tồn kho", "Vòng quay tài sản", "Biên lợi nhuận ròng", "CCC", "ROE"],
    ...
    "Vận tải - kho bãi": ["Biên EBITDA", "Vòng quay tài sản", "D/E", "Biên FCF", "ROE", "Upside"],
    "Khai khoáng": ["Biên EBITDA", "CAPEX/Doanh thu", "D/E", "Biên FCF", "ROE", "Upside"],
    "Công nghệ và thông tin": ["Tăng trưởng DT", "Biên gộp", "Biên lợi nhuận ròng",
                               "Biên FCF", "ROE", "Upside"],
    "Chăm sóc sức khỏe": ["Biên gộp", "Biên lợi nhuận ròng", "Chất lượng lợi nhuận", "D/E", "ROE", "Upside"],
    "Dịch vụ lưu trú, ăn uống, giải trí": ["Biên EBITDA", "Vòng quay tài sản", "D/E",
                                           "Biên FCF", "ROE", "Upside"],
}
